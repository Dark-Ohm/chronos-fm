//! Command-line interface: argument parsing plus the `chronos-fm config` subcommands
...
use chronos_fm_core::config::{self, ConfigOverride, ThemeMode};
use std::process::Command as ProcessCommand;

#[derive(Parser, Debug)]
#[command(name = "chronos-fm", version, about = "Launcher × Explorer file workspace")]
pub struct Cli {
