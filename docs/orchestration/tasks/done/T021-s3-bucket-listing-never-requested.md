...
локального RustFS.
**Фикс (2026-08-07):** реализован, юнит-зелёный (87 passed, включая новый
S3Page-кросс-тест), **ждёт живой приёмки** — отчёт в `report/T021-s3-bucket-listing-report.md`, изменения не закоммичены.
